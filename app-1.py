...
OWNER_CONTACT = "https://t.me/MasKyyOFFC"
...
def create_start_keyboard(chat_id):
    ...
    markup.row(types.InlineKeyboardButton("🔑  KEY ACCESS", callback_data="normal_key"), types.InlineKeyboardButton("⏱️  TIME KEY", callback_data="time_key"))
    markup.row(types.InlineKeyboardButton("💳  BUY KEY", url=OWNER_CONTACT))
    return markup
