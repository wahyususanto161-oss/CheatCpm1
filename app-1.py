...
def create_start_keyboard(chat_id):
    ...
    markup.row(types.InlineKeyboardButton("💎 GET PREMIUM ACCESS", url=OWNER_CONTACT))
    return markup
...
def section_cpm2(message):
    ...
    bot.send_message(
        ...
        "│        🎮 **CPM2 LOGIN**             │\n"
        "╠══════════════════════════════╣\n"
        "│ Masuk untuk membuka fitur CPM2.      │\n"
        "╚══════════════════════════════╝\n\n"
        "📧 **Masukkan email CPM2:**",
        parse_mode='Markdown'
    )
...
def menu_command(message):
    ...
    bot.send_message(
        ...
        "╚══════════════════════════════╝\n\n"
        "✨ Pilih panel yang ingin digunakan.",
