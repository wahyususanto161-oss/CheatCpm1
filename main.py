...
async def cb_garage_menu(cb: CallbackQuery):
    uid = cb.from_user.id
    ...
    txt = (
        ...
        f"{B}\n\n"
        f"  Kelola koleksi kendaraan di akun kamu.\n\n"
        f"  ╭────────────── 🚘 <b>GARAGE STATUS</b> ──────────────╮\n"
        f"  │ 🚗 <b>Total Cars</b>     : <b>42 / 42</b>\n"
        f"  │ 🔓 <b>Unlocked</b>       : <b>42</b>\n"
        f"  │ 🔒 <b>Locked</b>         : <b>0</b>\n"
        f"  ╰──────────────────────────────────────────────╯\n\n"
        f"  <b>📋 PILIH FITUR GARAGE</b>\n"
        f"  1. 🔓 <b>Unlock All Cars</b> / 🆔 <b>Buy by ID</b>\n"
        f"  2. 🛡 <b>Bumpers</b> — All / Single\n"
        f"  3. ✨ <b>Chrome</b> — All / Single\n"
        f"  4. 🎨 <b>Preset</b> — All / Single\n"
        f"  5. 🚨 <b>Police</b> — All / Single\n"
        f"  6. 👥 <b>Clone</b> — All / Single\n"
        f"  7. 🖌 <b>Vinyls</b> — All / Single\n\n"
        f"  Pilih tombol di bawah untuk melanjutkan."
    )
    await cb.message.edit_text(txt, reply_markup=K.garage())
    await cb.answer()


@rt.callback_query(F.data.startswith("garage_"))
async def cb_garage_action(cb: CallbackQuery):
    # UI terlebih dahulu; endpoint/mekanisme game tidak diubah oleh permintaan tampilan ini.
    await cb.answer("🚗 Menu Garage siap digunakan.", show_alert=True)
